...
class JadwalService {
  static Future<List<JadwalObat>> fetchJadwalObat() async {
    String url =
        "https://letzgoo.net/api/get_jadwal.php"; // Your endpoint for fetching data
    try {
  ...
  static Future<List<JadwalObat>> fetchJadwalById(String patientId) async {
    String uri = "https://letzgoo.net/api/get_jadwal.php?IDPasien=$patientId";
  ...
  static Future<Map<String, dynamic>> insertJadwal(
    ...
    String url = "https://letzgoo.net/api/insert_jadwal.php";
    try {
  ...
  static Future<Map<String, dynamic>> updateJadwal(
      Map<String, String> data) async {
    String url =
        "https://letzgoo.net/api/update_jadwal.php"; // Adjust IP as necessary
    try {
  ...
  static Future<Map<String, dynamic>> deleteJadwal(String id) async {
    String url =
        "https://letzgoo.net/api/delete_jadwal.php"; // Adjust for real IP if on physical device
    try {
